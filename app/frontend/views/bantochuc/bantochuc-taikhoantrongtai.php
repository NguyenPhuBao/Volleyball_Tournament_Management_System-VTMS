<section
    class="organizer-referee-accounts"
    data-accounts-api="<?= e(url('/api/organizer/referee-accounts')) ?>"
>
    <header class="accounts-topbar">
        <div>
            <p class="eyebrow">BAN TỔ CHỨC</p>
            <h1>Duyệt tài khoản Trọng tài</h1>
            <p class="sub">Quản lý và xét duyệt các tài khoản đăng ký với vai trò Trọng tài.</p>
        </div>
    </header>
...
<div class="accounts-modal hidden" id="detailModal" aria-hidden="true">
    <div class="modal-content wide" role="dialog" aria-modal="true" aria-labelledby="detailTitle">
        <div class="modal-head">
            <div>
                <h2 id="m_title">Chi tiết tài khoản trọng tài</h2>
        ...
        <div class="accounts-grid">
            ...
            <div>
                <label for="m_level">Cấp bậc trọng tài</label>
                <input id="m_level" disabled />
            </div>
            <div>
                <label for="m_refStatus">Trạng thái hồ sơ trọng tài</label>
                <input id="m_refStatus" disabled />
            </div>
