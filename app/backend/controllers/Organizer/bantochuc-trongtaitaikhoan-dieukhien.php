...
use App\Backend\Services\Organizer\OrganizerRefereeAccountService;

final class OrganizerRefereeAccountController extends Controller
{
    private OrganizerRefereeAccountService $service;

    public function __construct()
    {
        $this->service = new OrganizerRefereeAccountService();
    }
    ...
    public function page(Request $request): Response
    {
        ...
        if (($authorization['ok'] ?? false) !== true) {
            return $this->view('errors.403', [
                'pageTitle' => 'VTMS - Khong co quyen duyet tai khoan trong tai',
            ], 'main', 403);
        }

        return $this->view('bantochuc.referee-accounts', [
            'pageTitle' => 'VTMS - Duyệt tài khoản trọng tài',
            'styles' => ['css/organizer-coach-accounts.css'],
            'scripts' => ['js/organizer-referee-accounts.js'],
        ]);
    }
    ...
    private function notFound(): Response
    {
        return Response::json([
            'success' => false,
            'message' => 'Không tìm thấy tài khoản trọng tài.',
        ], 404);
    }
}
