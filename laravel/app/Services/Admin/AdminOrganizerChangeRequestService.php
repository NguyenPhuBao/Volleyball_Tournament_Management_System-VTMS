...
use App\Repositories\Admin\AdminOrganizerChangeRequestRepository;
...
final class AdminOrganizerChangeRequestService
{
    ...
    public function __construct(private readonly AdminOrganizerChangeRequestRepository $requests)
    {
    }
