...
use App\Repositories\Organizer\OrganizerVenueRepository;
...
final class OrganizerVenueService
{
    ...
    public function __construct(
        private readonly OrganizerVenueRepository $venues,
    ...
    public function locations(int $accountId, array $filters = []): array
    {
        ...
        return [
            ...
            'locations' => $this->organizers->competitionLocations((int) $organizer['idbantochuc'], [
                'q' => $keyword,
                'status' => $status,
            ]),
            'meta' => [
    ...
    public function all(int $accountId, array $filters = []): array
    {
        ...
        return [
            ...
            'venues' => $this->venues->listVenues($normalizedFilters['filters']),
            'meta' => [
    ...
    public function create(array $payload, int $accountId, ?Request $request = null): array
    {
        ...
        $location = $this->organizers->competitionLocationById((int) $venue['idvitrithidau'], (int) $organizer['idbantochuc']);
    ...
    public function update(int $venueId, array $payload, int $accountId, ?Request $request = null): array
    {
        ...
        $location = $this->organizers->competitionLocationById($locationId, (int) $organizer['idbantochuc']);
