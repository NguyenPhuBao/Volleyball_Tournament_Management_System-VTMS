...
@section('content')
    <section
        ...
        data-accounts-api="{{ url('/api/organizer/referee-accounts') }}"
    >
        <header class="accounts-topbar">
            <div>
                <p class="eyebrow">BAN TO CHUC</p>
                <h1>Duyet tai khoan trong tai</h1>
                <p class="sub">Quan ly va xet duyet cac tai khoan dang ky voi vai tro Trong tai.</p>
            </div>
        </header>
    ...
    <div class="accounts-modal hidden" id="detailModal" aria-hidden="true">
        <div class="modal-content wide" role="dialog" aria-modal="true" aria-labelledby="detailTitle">
            <div class="modal-head">
                <div>
                    <h2 id="m_title">Chi tiet tai khoan trong tai</h2>
            ...
            <div class="accounts-grid">
                ...
                <div>
                    <label for="m_level">Cap bac trong tai</label>
                    <input id="m_level" disabled>
                </div>
                <div>
                    <label for="m_refStatus">Trang thai ho so trong tai</label>
