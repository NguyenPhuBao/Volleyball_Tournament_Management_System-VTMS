...
@section('content')
    <section
        ...
        data-register-api="{{ url('/api/referee/register') }}"
        data-options-api="{{ url('/api/referee/register/options') }}"
    >
        <header class="coach-topbar">
            <div>
                <p class="eyebrow">TRONG TAI</p>
                <h1>Dang ky tai khoan Trong tai</h1>
                <p class="sub">Dien day du thong tin de gui yeu cau dang ky tai khoan trong tai.</p>
            </div>
        </header>
        ...
        <main class="coach-card">
            <form id="refereeRegisterForm">
                <div class="coach-grid">
                    ...
                    <div>
                        <label for="level">Cap bac trong tai *</label>
                        <select id="level" required>
                            <option value="">Dang tai cap bac...</option>
                        </select>
                    </div>
                    <div>
                ...
                <p class="hint">Sau khi gui, yeu cau se o trang thai Cho xac nhan va duoc BTC Lien doan bong chuyen xet duyet.</p>
            </form>
        </main>
    </section>
@endsection
